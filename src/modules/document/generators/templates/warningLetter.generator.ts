...
const normalizeParagraphs = (payload) => {
  ...
  return [...WARNING_LETTER_DEFAULT_PARAGRAPHS];
};
...
export const generateWarningLetterPdfBuffer = async (
  ...
  const introParagraph =
    typeof payload.introParagraph === 'string' && payload.introParagraph.trim()
      ...
      : `This letter confirms our discussion regarding ${
          payload.warningReason || payload.reason || 'recent conduct and performance concerns'
